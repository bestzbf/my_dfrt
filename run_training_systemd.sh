...
Environment:
  ROLLING_WARM_ENABLE=1   opt in to the rolling warm daemon. Default: 0.
  AUTO_WARM_INDEX_CACHE=0 skip one-time index cache warmup before training.
...
training_env=(
  ...
  "D4RT_PLANNED_RELAXED_LOOKAHEAD=128"
  ...
  "D4RT_SAMPLE_STAGE_DIRECT_CACHE_REBASE=1"
  ...
  "D4RT_DYNAMIC_REPLICA_IO_WORKERS=8"
  ...
  "PROFILE_DATA_LOADING=1"
  "D4RT_SLOW_SAMPLE_THRESHOLD_S=${D4RT_SLOW_SAMPLE_THRESHOLD_S:-99999}"
  "D4RT_EPOCH_STARTUP_SLEEP_S=${D4RT_EPOCH_STARTUP_SLEEP_S:-0}"
  "D4RT_SAMPLE_STAGE_SLOW_THRESHOLD_S=${D4RT_SAMPLE_STAGE_SLOW_THRESHOLD_S:-99999}"
)
