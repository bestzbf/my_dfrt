...
case "$STAGE" in
  ...
  target_cam_full)
    ...
    ;;
  full_main)
    QUERY_MODE="full"; PREV_STAGE="target_cam_full"; STEPS=6000; WARMUP=300
    L3D=1.0; LRAW3D=0.0; L2D=0.1; LVIS=0.0; LDISP=0.0; LNORM=0.0; LCONF=0.0; CONF_START=0; CONF_RAMP=0; CONF_WEIGHT_START=0; CONF_WEIGHT_RAMP=0
    ;;
  full_vis)
    QUERY_MODE="full"; PREV_STAGE="full_main"; STEPS=2000; WARMUP=100
    L3D=1.0; LRAW3D=0.0; L2D=0.1; LVIS=0.1; LDISP=0.0; LNORM=0.0; LCONF=0.0; CONF_START=0; CONF_RAMP=0; CONF_WEIGHT_START=0; CONF_WEIGHT_RAMP=0
    ;;
  full_aux)
    QUERY_MODE="full"; PREV_STAGE="full_vis"; STEPS=2000; WARMUP=100
    L3D=1.0; LRAW3D=0.0; L2D=0.1; LVIS=0.1; LDISP=0.1; LNORM=0.5; LCONF=0.0; CONF_START=0; CONF_RAMP=0; CONF_WEIGHT_START=0; CONF_WEIGHT_RAMP=0
    ;;
  full_full)
    QUERY_MODE="full"; PREV_STAGE="full_aux"; STEPS=4000; WARMUP=200
    L3D=1.0; LRAW3D=0.0; L2D=0.1; LVIS=0.1; LDISP=0.1; LNORM=0.5; LCONF=0.05; CONF_START=1000; CONF_RAMP=1000; CONF_WEIGHT_START=1000; CONF_WEIGHT_RAMP=1000
    ;;
  *)
