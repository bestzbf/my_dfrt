...
SCANNETPP_H5_CHUNK_CACHE_DIR="${SCANNETPP_H5_CHUNK_CACHE_DIR:-}"
SCANNETPP_H5_CHUNK_CACHE_MIN_BYTES="${SCANNETPP_H5_CHUNK_CACHE_MIN_BYTES:-4096}"
SCANNETPP_H5_CHUNK_CACHE_MAX_GB="${SCANNETPP_H5_CHUNK_CACHE_MAX_GB:-120}"
...
PREFETCH_DEPTH="${PREFETCH_DEPTH:-720}"
BATCH_PREFETCH_DEPTH="${BATCH_PREFETCH_DEPTH:-16}"
...
# Match training: DynamicReplica warms planned files exactly to avoid slow
# sequence-prefix scans.
