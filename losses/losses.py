...
def compute_depth_normalizers(
    ...
    if groups is not None:
        ...
        # Per-batch vectorized median (B is typically 2, each iteration fully GPU-vectorized)
        for batch_idx in range(B):
            ...
            # Lower median to match torch.Tensor.median() for even-sized groups
