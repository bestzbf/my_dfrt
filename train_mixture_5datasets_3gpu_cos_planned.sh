...
SAMPLE_STAGE_PRECLEAN_FORCE_LOW_WATERMARK="${SAMPLE_STAGE_PRECLEAN_FORCE_LOW_WATERMARK:-1}"
...
SCANNETPP_PRECOMPUTED_COS_TIMEOUT_S="${SCANNETPP_PRECOMPUTED_COS_TIMEOUT_S:-8}"
SCANNETPP_PRECOMPUTED_COS_RANGE_RETRIES="${SCANNETPP_PRECOMPUTED_COS_RANGE_RETRIES:-1}"
SCANNETPP_PRECOMPUTED_COS_RANGE_WORKERS="${SCANNETPP_PRECOMPUTED_COS_RANGE_WORKERS:-8}"
SCANNETPP_PRECOMPUTED_COS_RANGE_MERGE_GAP_BYTES="${SCANNETPP_PRECOMPUTED_COS_RANGE_MERGE_GAP_BYTES:-4194304}"
...
# DEFAULT_RESUME=""
DEFAULT_RESUME="/data/zbf/openclaw/d4rt/.claude/worktrees/cos-acceleration/outputs/mixture_6datasets_cos_planned_from200/checkpoint_latest_428.pth"
...
# DynamicReplica has large sequence directories. Warming only the planned RGB
# and trajectory files avoids coscli prefix/include scans that can tail at 100s+.
ROLLING_WARM_SDK_EXACT_DATASETS="${ROLLING_WARM_SDK_EXACT_DATASETS:-dynamic_replica}"
...
ROLLING_WARM_SCANNETPP_DEPTH_WORKERS="${ROLLING_WARM_SCANNETPP_DEPTH_WORKERS:-4}"
...
export D4RT_SLOW_SAMPLE_THRESHOLD_S="${D4RT_SLOW_SAMPLE_THRESHOLD_S:-15.0}"
export D4RT_SLOW_DATA_THRESHOLD_S="${D4RT_SLOW_DATA_THRESHOLD_S:-5.0}"
export D4RT_SAMPLE_STAGE_SLOW_THRESHOLD_S="${D4RT_SAMPLE_STAGE_SLOW_THRESHOLD_S:-15.0}"
...
load_normals_arg = sys.argv[48]
use_motion_boundaries_arg = sys.argv[49]
color_aug_after_resize_arg = sys.argv[50]
motion_boundary_on_resized_arg = sys.argv[51]
keep_cropped_images_arg = sys.argv[52].strip()
dynamic_replica_skip_depth_when_tracks_arg = sys.argv[53]
