...
SAMPLE_STAGE_CACHE_MAX_GB="${SAMPLE_STAGE_CACHE_MAX_GB:-220}"
...
D4RT_PLANNED_STARTUP_WARMUP_TIMEOUT_S="${D4RT_PLANNED_STARTUP_WARMUP_TIMEOUT_S:-60}"
D4RT_PLANNED_RELAXED_ORDER="${D4RT_PLANNED_RELAXED_ORDER:-1}"
D4RT_PLANNED_RELAXED_LOOKAHEAD="${D4RT_PLANNED_RELAXED_LOOKAHEAD:-64}"
