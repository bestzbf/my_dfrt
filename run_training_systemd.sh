...
training_env=(
  ...
  "D4RT_SAMPLE_STAGE_USAGE_FULL_RESCAN_INTERVAL_S=3600"
  "D4RT_SAMPLE_STAGE_DIRECT_CACHE_REBASE=0"
  "ROLLING_WARM_ENABLE=1"
  ...
  "ROLLING_WARM_DATASETS=dynamic_replica,co3dv2,scannetpp"
  "ROLLING_WARM_EXACT_DATASETS="
  "ROLLING_WARM_SDK_EXACT_DATASETS=dynamic_replica"
  ...
  "ROLLING_WARM_SCANNETPP_DEPTH_WORKERS=4"
  ...
  "SCANNETPP_PRECOMPUTED_COS_RANGE_WORKERS=8"
